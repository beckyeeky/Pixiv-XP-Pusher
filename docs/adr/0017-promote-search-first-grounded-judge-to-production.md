...
ADR-0018 extends that single AI Classification Record with bounded, redacted Grounding provenance. It does not introduce a second decision or evidence path.
